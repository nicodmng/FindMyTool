...
SWIFT_CLASS("_TtC10MessageKit26MessagesInputContainerView")
@interface MessagesInputContainerView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface MessagesViewController (SWIFT_EXTENSION(MessageKit)) <UIGestureRecognizerDelegate>
